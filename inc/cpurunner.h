...
static Opcode opcodes[256] = {
    {"BRK", ""},    {"ORA (", ",X)"}, {"KIL", ""},    {"SLO (", ",X)"}, {"NOP", ""},    {"ORA ", ""},
    {"ASL ", ""},   {"SLO ", ""},     {"PHP", ""},    {"ORA #", ""},    {"ASL ", "A"},  {"ANC #", ""},
    {"NOP", ""},    {"ORA ", ""},     {"ASL ", ""},   {"SLO ", ""},

    {"BPL ", ""},   {"ORA (", "),Y"}, {"KIL", ""},    {"SLO (", "),Y"}, {"NOP", ""},    {"ORA ", ",X"},
    {"ASL ", ",X"}, {"SLO ", ",X"},   {"CLC", ""},    {"ORA ", ",Y"},   {"NOP", ""},    {"SLO ", ",Y"},
    {"NOP", ""},    {"ORA ", ",X"},   {"ASL ", ",X"}, {"SLO ", ",X"},

    {"JSR ", ""},   {"AND (", ",X)"}, {"KIL", ""},    {"RLA (", ",X)"}, {"BIT ", ""},   {"AND ", ""},
    {"ROL ", ""},   {"RLA ", ""},     {"PLP", ""},    {"AND #", ""},    {"ROL ", "A"},  {"ANC #", ""},
    {"BIT ", ""},   {"AND ", ""},     {"ROL ", ""},   {"RLA ", ""},

    {"BMI ", ""},   {"AND (", "),Y"}, {"KIL", ""},    {"RLA (", "),Y"}, {"NOP", ""},    {"AND ", ",X"},
    {"ROL ", ",X"}, {"RLA ", ",X"},   {"SEC", ""},    {"AND ", ",Y"},   {"NOP", ""},    {"RLA ", ",Y"},
    {"NOP", ""},    {"AND ", ",X"},   {"ROL ", ",X"}, {"RLA ", ",X"},

    {"RTI", ""},    {"EOR (", ",X)"}, {"KIL", ""},    {"SRE (", ",X)"}, {"NOP", ""},    {"EOR ", ""},
    {"LSR ", ""},   {"SRE ", ""},     {"PHA", ""},    {"EOR #", ""},    {"LSR ", "A"},  {"ALR #", ""},
    {"JMP ", ""},   {"EOR ", ""},     {"LSR ", ""},   {"SRE ", ""},

    {"BVC ", ""},   {"EOR (", "),Y"}, {"KIL", ""},    {"SRE (", "),Y"}, {"NOP", ""},    {"EOR ", ",X"},
    {"LSR ", ",X"}, {"SRE ", ",X"},   {"CLI", ""},    {"EOR ", ",Y"},   {"NOP", ""},    {"SRE ", ",Y"},
    {"NOP", ""},    {"EOR ", ",X"},   {"LSR ", ",X"}, {"SRE ", ",X"},

    {"RTS", ""},    {"ADC (", ",X)"}, {"KIL", ""},    {"RRA (", ",X)"}, {"NOP", ""},    {"ADC ", ""},
    {"ROR ", ""},   {"RRA ", ""},     {"PLA", ""},    {"ADC #", ""},    {"ROR ", "A"},  {"ARR #", ""},
    {"JMP ", ""},   {"ADC ", ""},     {"ROR ", ""},   {"RRA ", ""},

    {"BVS ", ""},   {"ADC (", "),Y"}, {"KIL", ""},    {"RRA (", "),Y"}, {"NOP", ""},    {"ADC ", ",X"},
    {"ROR ", ",X"}, {"RRA ", ",X"},   {"SEI", ""},    {"ADC ", ",Y"},   {"NOP", ""},    {"RRA ", ",Y"},
    {"NOP", ""},    {"ADC ", ",X"},   {"ROR ", ",X"}, {"RRA ", ",X"},

    {"NOP", ""},    {"STA (", ",X)"}, {"NOP", ""},    {"SAX (", ",X)"}, {"STY ", ""},   {"STA ", ""},
    {"STX ", ""},   {"SAX ", ""},     {"DEY", ""},    {"NOP", ""},      {"TXA", ""},    {"XAA #", ""},
    {"STY ", ""},   {"STA ", ""},     {"STX ", ""},   {"SAX ", ""},

    {"BCC ", ""},   {"STA (", "),Y"}, {"KIL", ""},    {"AHX (", "),Y"}, {"STY ", ",X"}, {"STA ", ",X"},
    {"STX ", ",Y"}, {"SAX ", ",Y"},   {"TYA", ""},    {"STA ", ",Y"},   {"TXS", ""},    {"TAS", ""},
    {"SHY ", ",X"}, {"STA ", ",X"},   {"SHX ", ",X"}, {"AHX ", ""},

    {"LDY #", ""},  {"LDA (", ",X)"}, {"LDX #", ""},  {"LAX (", ",X)"}, {"LDY ", ""},   {"LDA ", ""},
    {"LDX ", ""},   {"LAX ", ""},     {"TAY", ""},    {"LDA #", ""},    {"TAX", ""},    {"LAX #", ""},
    {"LDY ", ""},   {"LDA ", ""},     {"LDX ", ""},   {"LAX ", ",Y"},

    {"BCS ", ""},   {"LDA (", "),Y"}, {"KIL", ""},    {"LAX (", "),Y"}, {"LDY ", ",X"}, {"LDA ", ",X"},
    {"LDX ", ",Y"}, {"LAX ", ",Y"},   {"CLV", ""},    {"LDA ", ",Y"},   {"TSX", ""},    {"LAS ", ""},
    {"LDY ", ""},   {"LDA ", ",X"},   {"LDX ", ""},   {"LAX ", ",Y"},

    {"CPY #", ""},  {"CMP (", ",X)"}, {"NOP", ""},    {"DCP (", ",X)"}, {"CPY ", ""},   {"CMP ", ""},
    {"DEC ", ""},   {"DCP ", ""},     {"INY", ""},    {"CMP #", ""},    {"DEX", ""},    {"AXS #", ""},
    {"CPY ", ""},   {"CMP ", ""},     {"DEC ", ""},   {"DCP ", ",X"},

    {"BNE ", ""},   {"CMP (", "),Y"}, {"KIL", ""},    {"DCP (", "),Y"}, {"NOP", ""},    {"CMP ", ",X"},
    {"DEC ", ",X"}, {"DCP ", ",X"},   {"CLD", ""},    {"CMP ", ",Y"},   {"NOP", ""},    {"DCP ", ",Y"},
    {"NOP", ""},    {"CMP ", ",X"},   {"DEC ", ",X"}, {"DCP ", ",X"},

    {"CPX #", ""},  {"SBC (", ",X)"}, {"NOP", ""},    {"ISC (", ",X)"}, {"CPX ", ""},   {"SBC ", ""},
    {"INC ", ""},   {"ISC ", ""},     {"INX", ""},    {"SBC #", ""},    {"NOP", ""},    {"SBC #", ""},
    {"CPX ", ""},   {"SBC ", ""},     {"INC ", ""},   {"ISC ", ",X"},

    {"BEQ ", ""},   {"SBC (", "),Y"}, {"KIL", ""},    {"ISC (", "),Y"}, {"NOP", ""},    {"SBC ", ",X"},
    {"INC ", ",X"}, {"ISC ", ",X"},   {"SED", ""},    {"SBC ", ",Y"},   {"NOP", ""},    {"ISC ", ",Y"},
    {"NOP", ""},    {"SBC ", ",X"},   {"INC ", ""},   {"ISC ", ",X"}};

static const int opcodeCycles[256] = {
    7, 6, 0, 0, 0, 3, 5, 0, 3, 2, 2, 0, 0, 4, 6, 0, 2, 5, 0, 0, 0, 4, 6, 0, 2, 4, 0, 0, 0, 4, 7, 0, 6, 6, 0, 0, 3,
    3, 5, 0, 4, 2, 2, 0, 4, 4, 6, 0, 2, 5, 0, 0, 0, 4, 6, 0, 2, 4, 0, 0, 0, 4, 7, 0, 6, 6, 0, 0, 0, 3, 5, 0, 3, 2,
    2, 0, 3, 4, 6, 0, 2, 5, 0, 0, 0, 4, 6, 0, 2, 4, 0, 0, 0, 4, 7, 0, 6, 6, 0, 0, 0, 3, 5, 0, 4, 2, 2, 0, 5, 4, 6,
    0, 2, 5, 0, 0, 0, 4, 6, 0, 2, 4, 0, 0, 0, 4, 7, 0, 0, 6, 0, 0, 3, 3, 3, 0, 2, 0, 2, 0, 4, 4, 4, 0, 2, 6, 0, 0,
    4, 4, 4, 0, 2, 5, 2, 0, 0, 5, 0, 0, 2, 6, 2, 0, 3, 3, 3, 0, 2, 2, 2, 0, 4, 4, 4, 0, 2, 5, 0, 0, 4, 4, 4, 0, 2,
    4, 2, 0, 4, 4, 4, 0, 2, 6, 0, 0, 3, 3, 5, 0, 2, 2, 2, 0, 4, 4, 6, 0, 2, 5, 0, 0, 0, 4, 6, 0, 2, 4, 0, 0, 0, 4,
    7, 0, 2, 6, 0, 0, 3, 3, 5, 0, 2, 2, 2, 0, 4, 4, 6, 0, 2, 5, 0, 0, 0, 4, 6, 0, 2, 4, 0, 0, 0, 4, 7, 0};
