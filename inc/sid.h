...
typedef struct {
    ...
    uint8_t attack_decay_voice1;      // $D405 / 54277: Anschlag (0*16 hart ... 15*16 weich) / Abschwellen Stimme 1 (+ 0 hart ... 15 weich)
    uint8_t sustain_release_voice1;   // $D406 / 54278: Halten (0*16 stumm ... 15*16 laut) / Ausklingen Stimme 1 (+ 0 schnell ... 15 langsam)
    ...
    uint8_t attack_decay_voice2;      // $D40C / 54284: Anschlag (0*16 hart ... 15*16 weich) / Abschwellen Stimme 2 (+ 0 hart ... 15 weich)
    uint8_t sustain_release_voice2;   // $D40D / 54285: Halten (0*16 stumm ... 15*16 laut) / Ausklingen Stimme 2 (+ 0 schnell ... 15 langsam)
    ...
    uint8_t attack_decay_voice3;      // $D413 / 54291: Anschlag (0*16 hart ... 15*16 weich) / Abschwellen Stimme 3 (+ 0 hart ... 15 weich)
    uint8_t sustain_release_voice3;   // $D414 / 54292: Halten (0*16 stumm ... 15*16 laut) / Ausklingen Stimme 3 (+ 0 schnell ... 15 langsam)
    ...
    uint8_t filter_resonance;         // $D417 / 54295: Resonanz; 0 keine; 15*16 stark; (+ Filter für 1. Stimme 1; 2. Stimme 2; 3. Stimme 4; extern 8)
